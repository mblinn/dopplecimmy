...
public abstract class PircBot implements ReplyConstants {
     ...
     */
    public final void dccReceiveFile(File file, long address, int port, int size) {
     ...
     */
    public final DccChat dccAcceptChatRequest(String sourceNick, long address, int port) {
     ...
     * public and only called by the InputThread for this instance.
     *  <p>
     * This method may not be overridden!
     * 
